...
const FALLBACK_EXCEPTIONS: ExceptionRequest[] = [
  { id: 'EXC-001', application_id: 'payments-api', requestor_email: 'alice@cloudforge.dev', request_type: 'UNAPPROVED_REGION', policy_violated: 'region-restriction', resource_requested: 'RDS in ap-southeast-3', business_case: 'APAC expansion requires local DB replica for <10ms latency', status: 'PENDING', approver_chain: [approver('bob@cloudforge.dev')], created_at: '2026-02-25T10:30:00Z', updated_at: '2026-02-25T10:30:00Z' },
  { id: 'EXC-002', application_id: 'data-pipeline', requestor_email: 'carol@cloudforge.dev', request_type: 'OVERSIZED_INSTANCE', policy_violated: 'instance-size-limit', resource_requested: 'EC2 m5.24xlarge', business_case: 'ML training workload requires 384GB RAM for model fitting', status: 'PENDING', approver_chain: [approver('dave@cloudforge.dev')], created_at: '2026-02-24T14:15:00Z', updated_at: '2026-02-24T14:15:00Z' },
  { id: 'EXC-003', application_id: 'ml-training', requestor_email: 'eve@cloudforge.dev', request_type: 'RESTRICTED_SERVICE', policy_violated: 'service-allowlist', resource_requested: 'Bedrock us-gov-west-1', business_case: 'FedRAMP compliance testing requires GovCloud inference endpoint', status: 'APPROVED', approver_chain: [approver('frank@cloudforge.dev')], created_at: '2026-02-23T09:00:00Z', updated_at: '2026-02-24T11:00:00Z' },
  { id: 'EXC-004', application_id: 'auth-service', requestor_email: 'grace@cloudforge.dev', request_type: 'NETWORK_EXPOSURE', policy_violated: 'no-public-ingress', resource_requested: 'SG sg-0abc1234 port 22', business_case: 'Temporary SSH access for incident response', status: 'PENDING', approver_chain: [approver('heidi@cloudforge.dev')], created_at: '2026-02-22T16:45:00Z', updated_at: '2026-02-22T16:45:00Z' },
  { id: 'EXC-005', application_id: 'analytics-dash', requestor_email: 'ivan@cloudforge.dev', request_type: 'DATA_RESIDENCY', policy_violated: 'data-residency-eu', resource_requested: 'S3 bucket in us-east-1', business_case: 'Cross-region replication for DR — EU primary, US failover', status: 'REJECTED', approver_chain: [approver('judy@cloudforge.dev')], created_at: '2026-02-20T08:30:00Z', updated_at: '2026-02-21T09:00:00Z' },
  { id: 'EXC-006', application_id: 'crm-platform', requestor_email: 'karl@cloudforge.dev', request_type: 'OTHER', policy_violated: 'encryption-at-rest', resource_requested: 'DynamoDB without KMS', business_case: 'Legacy integration — vendor SDK does not support CMK encryption', status: 'EXPIRED', approver_chain: [approver('liam@cloudforge.dev')], created_at: '2026-02-15T12:00:00Z', updated_at: '2026-03-01T00:00:00Z' },
]
