...
import { ArrowLeft, ExternalLink, CheckCircle2, AlertTriangle, Brain, Crosshair, Building2, Zap, Globe, Flame, Server, ChevronRight, Clock, MessageSquare, Search, CircleDot, Wrench, UserCheck, XCircle, Ticket as TicketIcon } from 'lucide-react'
