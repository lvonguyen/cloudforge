...
const SEVERITY_CLASS: Record<string, string> = {
  critical: 'border-red-300 bg-red-50 dark:border-red-800 dark:bg-red-950/20',
  high: 'border-orange-300 bg-orange-50 dark:border-orange-800 dark:bg-orange-950/20',
  medium: 'border-yellow-300 bg-yellow-50 dark:border-yellow-800 dark:bg-yellow-950/20',
