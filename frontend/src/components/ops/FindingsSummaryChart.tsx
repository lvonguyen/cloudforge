...
export function FindingsSummaryChart({ findings }: Props) {
  ...
  return (
    <div className="p-4 space-y-6">
      <div>
        <div id="findings-summary-provider-title" className="text-[10px] font-semibold uppercase tracking-widest text-gray-500 mb-3">
          Severity by Provider
        </div>
        <div
          role="img"
          aria-labelledby="findings-summary-provider-title"
          aria-label="Stacked bar chart showing finding severity counts grouped by cloud provider"
        >
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={providerData} margin={{ top: 4, right: 8, left: 0, bottom: 0 }}>
              ...
              <Bar dataKey="CRITICAL" stackId="a" fill={SEVERITY_HEX.CRITICAL} />
      ...
      <div>
        <div id="findings-summary-workflow-title" className="text-[10px] font-semibold uppercase tracking-widest text-gray-500 mb-3">
          Workflow Status
        </div>
        <div
          role="img"
          aria-labelledby="findings-summary-workflow-title"
          aria-label="Horizontal bar chart showing counts of findings by workflow status"
        >
