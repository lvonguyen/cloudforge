...
export const MOCK_EXCEPTIONS: ExceptionRequest[] = [
  {
    ...
    requestor_email: 'sarah.chen@cloudforge.io',
    ...
    status: 'PENDING',
    approver_chain: [
      { email: 'maria.santos@cloudforge.io', role: 'SECURITY_LEAD', decision: 'PENDING', comments: '' },
      { email: 'james.wright@cloudforge.io', role: 'GRC_ANALYST', decision: 'PENDING', comments: '' },
    ],
  ...
  },
  {
    ...
    requestor_email: 'alex.kumar@cloudforge.io',
    ...
    status: 'APPROVED',
    approver_chain: [
      { email: 'maria.santos@cloudforge.io', role: 'SECURITY_LEAD', decision: 'APPROVED', comments: 'Approved with 72h TTL', decided_at: '2026-03-08T14:00:00Z' },
    ],
  ...
  },
  {
    ...
    status: 'REJECTED',
    approver_chain: [
      { email: 'maria.santos@cloudforge.io', role: 'SECURITY_LEAD', decision: 'REJECTED', comments: 'Use API Gateway with mutual TLS instead', decided_at: '2026-03-05T10:00:00Z' },
    ],
