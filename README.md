...
> **About this project** — CloudForge demonstrates enterprise security patterns I've designed and operated across identity, infrastructure, governance, and software lifecycle domains throughout my career as a Senior Security Architect. It is a **portfolio-grade reference architecture**, not a production SaaS product — select vertical slices (ServiceNow GRC, JWT auth, S3/SSH remediation) are fully implemented while others are architectural stubs backed by threat models and ADRs. I use security-focused systems design as my core discipline and agentic coding workflows (Claude Code) as a force multiplier for delivery.
>
